...
## Latest Backup
- **SQL File**: prod-backup-default-2025-11-10-123541.sql
- **Metadata**: prod-backup-default-2025-11-10-123541.json
- **Date**: 2025-11-10 12:35:44
- **Environment**: default
- **Size**: 9.8K
...
```bash
cat backups/prod-backup-default-2025-11-10-123541.json
```
...
wrangler d1 execute payload-cms-cloudflare-baseline \
  --remote \
  --file=backups/prod-backup-default-2025-11-10-123541.sql
